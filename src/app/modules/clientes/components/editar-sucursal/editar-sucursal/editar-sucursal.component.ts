...
@Component({
  ...
  <form>
    ...
    <p-button label="Editar" (onClick)="editarSucursal()"></p-button>
...
export class EditarSucursalComponent {
    ...
    public editarSucursal(){
            ...
            //const formData = new FormData
            this.empresaService.editarSucursal(this.id_sucursal, this.id_empresa, formData).subscribe((resp:any)=>{
    ...
    public obtenerDatos(){
        if (this.direccionSelected) {
            ...
            if (selectedDireccion) {
                ...
                this.nombre = selectedDireccion.nombre_sucursal;
